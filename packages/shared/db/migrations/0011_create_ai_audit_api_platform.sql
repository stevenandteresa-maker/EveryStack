-- Migration 0011: Infrastructure & utility tables
-- ai_usage_log, ai_credit_ledger, audit_log, api_keys, api_request_log,
-- user_recent_items, command_bar_sessions, feature_suggestions, feature_votes
--
-- Three tables use time-partitioning by created_at (monthly):
--   ai_usage_log, audit_log, api_request_log

-- ============================================================
-- 1. ai_usage_log (partitioned by month)
-- ============================================================
CREATE TABLE "ai_usage_log" (
	...
	CONSTRAINT "ai_usage_log_pkey" PRIMARY KEY ("id", "created_at")
...
-- ============================================================
-- 2. ai_credit_ledger (regular table with generated column)
-- ============================================================
...
-- ============================================================
-- 3. audit_log (partitioned by month)
-- ============================================================
...
-- ============================================================
-- 5. api_request_log (partitioned by month, 30-day retention)
-- ============================================================
CREATE TABLE "api_request_log" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "api_request_log_pkey" PRIMARY KEY ("id", "created_at")
) PARTITION BY RANGE ("created_at");
--> statement-breakpoint
...
-- ============================================================
-- 6. user_recent_items (regular table)
-- ============================================================
...
-- ============================================================
-- 7. command_bar_sessions (regular table)
-- ============================================================
...
-- ============================================================
-- 8. feature_suggestions (regular table)
-- ============================================================
...
CREATE UNIQUE INDEX "user_recent_items_user_item_idx" ON "user_recent_items" USING btree ("user_id","item_type","item_id");--> statement-breakpoint

-- command_bar_sessions indexes
...
-- feature_votes indexes
CREATE UNIQUE INDEX "feature_votes_suggestion_user_idx" ON "feature_votes" USING btree ("suggestion_id","user_id");
